...
export const PROJECTS: Project[] = [
  ...
  {
    id: 4,
    title: 'AgriToken - Agricultural Asset Tokenization',
    description: 'Tokenizing Agriculture, Empowering Farmers. Register real-world farm assets like livestock and crops on the blockchain.',
    imageUrl: getImageForIndex(3),
    url: 'https://land-chain-africa.vercel.app/',
    tags: ['Blockchain', 'Agriculture', 'Web3', 'Tokenization'],
    category: 'Web3 & Blockchain',
  ...
  },
  {
    id: 103,
    title: 'Pulp Factual',
    description: 'A podcast about endodontics.',
    imageUrl: getImageForIndex(3),
    url: 'https://open.spotify.com/show/6nOARyZH4G5XK5sly52X5M?si=3nMgkCyLREawC0Vt2OdnGA',
    tags: ['Podcast', 'Spotify', 'Audio', 'Health', 'Dentistry', 'Endodontics'],
    category: 'Creative & Media',
    createdAt: '2026-04-03',
  },
  {
    id: 104,
    title: 'The Implant Talk',
    description: 'A podcast dedicated to discussions around dental implants and oral health.',
    imageUrl: getImageForIndex(4),
    url: 'https://open.spotify.com/show/4akFY4frLLKbLUuqjvHGlt?si=eFeG-MumQO2DbIStUAH52g',
    tags: ['Podcast', 'Spotify', 'Audio', 'Health', 'Dentistry'],
    category: 'Creative & Media',
    createdAt: '2026-04-03',
  }
];